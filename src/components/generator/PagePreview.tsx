...
export const PagePreview = ({
  ...
  const handlePaymentSubmit = async (paymentData: CreditCardData) => {
    ...
    try {
      ...
      // Save the page after successful payment
        ...
        <div className="min-h-screen" style={{
          ...
          <section className="px-4 py-6">
            <div className="text-center mb-6">
              ...
              <p className="text-muted-foreground italic text-xs px-4">
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Fullscreen Views */}
      {isMobileFullscreen && renderMobileFullscreen()}
          ...
          <div className="lg:col-span-2">
            <Card className="h-full">
              ...
              <CardContent className="p-0">
                <div className={`transition-all duration-300 ${viewMode === 'mobile' ? 'max-w-md mx-auto border-8 border-gray-300 rounded-3xl bg-gray-300 p-2' : 'w-full'}`}>
