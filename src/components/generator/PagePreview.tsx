          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-3">
                {/* Conversion Score */}
                <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-lg p-4 text-center hover:shadow-md transition-shadow cursor-pointer">
                  <div className="text-2xl font-bold text-green-700">94%</div>
                  <div className="text-xs text-green-600 mt-1">Conversion Score</div>
                </div>

                {/* SEO Rating */}
                <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 border border-emerald-200 rounded-lg p-4 text-center hover:shadow-md transition-shadow cursor-pointer">
                  <div className="text-2xl font-bold text-emerald-700">A+</div>
                  <div className="text-xs text-emerald-600 mt-1">SEO Rating</div>
                </div>

                {/* Load Time */}
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-4 text-center hover:shadow-md transition-shadow cursor-pointer">
